...
var LinkedList = /** @class */ (function () {
    ...
    LinkedList.prototype.find = function (index, inclusive, includeBreak) {
        if (inclusive === void 0) { inclusive = false; }
        if (includeBreak === void 0) { includeBreak = false; }
        var cur, next = this.iterator();
        while ((cur = next())) {
    ...
    LinkedList.prototype.forEachAt = function (index, length, callback, includeBreak) {
        if (includeBreak === void 0) { includeBreak = false; }
        if (length <= 0)
            return;
        var _a = this.find(index, false, includeBreak), startNode = _a[0], offset = _a[1];
